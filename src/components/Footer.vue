      ...
      <div class="border-t border-gray-800 py-8">
        <div class="text-center space-y-2">
          <div class="text-gray-400 text-sm">
            © 2024 ANGELETTE INCORPORADORA. Todos os direitos reservados.
          </div>
          
          <div class="text-gray-400 text-sm">
            Criado por 
            <a 
              href="https://wa.me/5521993350228?text=Vim através do site da ANGELETTE INCORPORADORA e gostaria de saber mais sobre seu trabalho"
              target="_blank"
...
const socialLinks = [
  ...
  {
    icon: 'whatsapp',
    href: 'https://wa.me/5521994237110?text=Olá, ANGELETTE INCORPORADORA! Vim através do seu site, gostaria de saber mais informações.',
    label: 'WhatsApp',
